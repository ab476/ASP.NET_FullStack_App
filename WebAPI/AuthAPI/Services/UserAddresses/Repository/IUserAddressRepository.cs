...
public interface IUserAddressRepository
{
    ...
    Task<Guid?> GetUserIdByAddressIdAsync(Guid addressId, CancellationToken ct);
    ...
    Task<bool> UpdateAsync(Guid id, UpdateUserAddressRequest request, CancellationToken ct);
